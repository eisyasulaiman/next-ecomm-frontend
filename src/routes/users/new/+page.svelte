...
<h1 class="text-center text-xl">A click away from posting your first image!</h1>
...
<div class="form-control w-full">
  ...
  {/if}
      ...
      <div class="text-center">
        <a class="link-hover italic text-xs" href="/login"> Login with existing account instead</a>
    </div>
   </form>
</div>